...
*/
/*
-> id (PK de pieza_dental) dejarlo como int, ya que se puede autoincrementar
*/
...
/*
-> id_pieza_dental sería int también
-> cara_afectada dejarlo como null, ya que tratamientos como validacion, blanqueamiento o limpieza son generales (aplican a todas las piezas)
-> id_pieza_dental mirar si se puede dejar como null también, ya que como en cara afectada, algunos tratamientos pueden ser generales
Por ende:
...
/*
--> numero_pago cambiar a varchar, dejando el unique, para que se digite de la siguiente forma: 'P-00001' y sucesivamente
*/
-- Tabla Pago
insert into pago (id_cita, numero_pago, id_metodo_pago, fecha_pago, monto_pagado, estado_pago) values
