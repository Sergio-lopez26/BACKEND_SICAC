...
(1, '1233504140', 'andrejur055@gmail.com', encode(digest('encriptaraqui01' || 'andrejur055@gmail.com', 'sha256'), 'hex'), '1999-02-09', 'Jeison', 'Andrey', 'Sosa','Espitia', '3203720455', 'O+', NULL, NULL),
(2, '1023456789', 'laura.martinez@gmail.com', encode(digest('clave01' || 'laura.martinez@gmail.com', 'sha256'), 'hex'), '2005-07-12', 'Laura', 'Sofía', 'Martínez', 'Gómez', '3114567890', 'A+', 'Alfonso Martínez', '798456345'),
(1, '798456123', 'carlos.ruiz@gmail.com', encode(digest('clave02' || 'carlos.ruiz@gmail.com', 'sha256'), 'hex'), '1988-11-23', 'Carlos', 'Andrés', 'Ruiz', 'Pérez', '3001234567', 'B+', NULL, NULL),
(3, '456789123', 'maria.lopez@gmail.com', encode(digest('clave03' || 'maria.lopez@gmail.com', 'sha256'), 'hex'), '1995-03-30', 'María', NULL, 'López', 'Ramírez', '3209876543', 'O-', NULL, NULL),
(1, '1547896320', 'juan.castro@gmail.com', encode(digest('clave04' || 'juan.castro@gmail.com', 'sha256'), 'hex'), '1992-09-15', 'Juan', 'David', 'Castro', NULL, '3102345678', 'AB+', NULL, NULL),
(2, '1122334455', 'sofia.torres@gmail.com', encode(digest('clave05' || 'sofia.torres@gmail.com', 'sha256'), 'hex'), '2008-01-20', 'Sofía', 'Alejandra', 'Torres', 'Vargas', '3156789012', 'A-', 'Emiliana Vargas', '798567345'),
(1, '987654321', 'andres.moreno@gmail.com', encode(digest('clave06' || 'andres.moreno@gmail.com', 'sha256'), 'hex'), '1985-06-10', 'Andrés', NULL, 'Moreno', 'Rojas', '3008765432', 'O+', NULL, NULL),
(3, '321654987', 'luis.garcia@gmail.com', encode(digest('clave07' || 'luis.garcia@gmail.com', 'sha256'), 'hex'), '1990-12-05', 'Luis', 'Alberto', 'García', 'Jiménez', '3193456789', 'B-', NULL, NULL),
(1, '741852963', 'paula.restrepo@gmail.com', encode(digest('clave08' || 'paula.restrepo@gmail.com', 'sha256'), 'hex'), '1998-04-18', 'Paula', 'Andrea', 'Restrepo', 'Cano', '3125678901', 'AB-', NULL, NULL),
(2, '159357486', 'diego.herrera@gmail.com', encode(digest('clave09' || 'diego.herrera@gmail.com', 'sha256'), 'hex'), '2006-08-27', 'Diego', NULL, 'Herrera', 'Ortiz', '3147890123', 'O+', 'Mario Herrera', '798789345'),
(1, '753951456', 'valentina.suarez@gmail.com', encode(digest('clave10' || 'valentina.suarez@gmail.com', 'sha256'), 'hex'), '2000-10-09', 'Valentina', 'Lucía', 'Suárez', 'Mendoza', '3168901234', 'A+', NULL, NULL);
